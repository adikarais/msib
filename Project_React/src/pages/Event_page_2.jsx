...
import '../assets/css/Event_page_2.css'

function Event_page_2() {
  return (
    <div>
      <head>
        <meta charSet="UTF-8" />
        ...
        <main>
          <section className="event-details">
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                    <div class="feature-box">
                        <div class="img" style={{ textIndent: '20em',  fontSize: '6.6px' }}>
                            <img src="/assets/img/teater3.png" alt="artwork" />
                        </div>
                        ...
                        <div class="content">
                          ...
                          <h1>Revolusi</h1>
                            <i class='bx bx-calendar-week'>  Minggu, 27 Oktober 2024</i><p></p>
            ...
            <i class='bx bx-bookmark' style={{ textIndent: '33em',  fontSize: '31px' }}></i>
              ...
              <i class='bx bx-calendar-week'> Minggu, 27 Oktober 2024  <i class='bx bx-chair' style={{ textIndent: '13em' }}> 200 orang</i>  </i><br/>
              <i class='bx bx-time-five'> 18.00-20.00 &emsp;  <i class='bx bx-money' style={{ textIndent: '17em' }}></i> mulai dari Rp100.000</i><br/>
              <i class='bx bx-map'> Art Center, Denpasar, Indonesia  <button className="btn-small btn-warning">maps</button></i><br/>

              <p>
              Revolusi adalah sebuah potret indah sekaligus menyayat hati tentang keindahan dan kepahitan perubahan. 
              Melalui tarian, musik, dan dialog yang penuh makna, pertunjukan ini akan menyentuh hati penonton dan mengajak mereka untuk merenungkan arti dari sebuah kehidupan yang terus bergerak.
                <br>
              Revolusi mengisahkan tentang lika-liku kehidupan seorang manusia yang terus berjuang melawan arus perubahan. 
              Dalam setiap babak hidupnya, ia dihadapkan pada pilihan-pilihan sulit yang membentuk siapa dirinya saat ini. 
              Pertunjukan ini akan membawa penonton pada sebuah eksplorasi mendalam tentang identitas, ketakutan, dan harapan.sah cinta yang tak kunjung usai, 
              di mana harapan dan keputusasaan saling beradu.
              </br>
              </p>

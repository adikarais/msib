...
import '../assets/css/Event_page_1.css'

function Event_page_1() {
  return (
    <div>
      <head>
        <meta charSet="UTF-8" />
        ...
        <main>
          <section className="event-details">
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                    <div class="feature-box">
                        <div class="img" style={{ textIndent: '20em',  fontSize: '6.6px' }}>
                            <img src="/assets/img/teaterr2.png" alt="artwork" />
                        </div>
                        ...
                        <div class="content">
                          ...
                          <h1>Setengah Hati</h1>
                            <i class='bx bx-calendar-week'>  Selasa, 29 Oktober 2024</i><p></p>
            ...
            <i class='bx bx-bookmark' style={{ textIndent: '33em',  fontSize: '31px' }}></i>
              <h1><br/>Setengah Hati</h1>
              <p><a href="/Profile_Page_komunitas">Teater Jakarta </a></p>
  

              <i class='bx bx-calendar-week'> Selasa, 29 Oktober 2024   <i class='bx bx-chair' style={{ textIndent: '13em' }}> 200 orang</i>  </i><br/>
              <i class='bx bx-time-five'> 18.00-20.00 &emsp;  <i class='bx bx-money' style={{ textIndent: '17em' }}></i>Free</i><br/>
              <i class='bx bx-map'> Teater Jakarta, Jakarta, Indonesia    <button className="btn-small btn-warning">maps</button></i><br/>

              <p>
              Pernahkah Anda merasakan cinta yang hanya setengah? 
              Setengah Hati adalah sebuah pertunjukan teater yang akan membawa Anda pada sebuah perjalanan emosional yang mendalam. M
              enceritakan sebuah kisah tentang dua insan yang terjebak dalam sebuah hubungan yang semakin memudar. 
              Di satu sisi, seorang pria berjuang keras untuk mempertahankan cinta mereka, sementara di sisi lain, 
              seorang wanita merasa tak ada lagi harapan untuk melanjutkan kisah ini. 
              Pertunjukan ini akan membawa Anda dalam perjalanan emosional yang penuh lika-liku, di mana cinta, harapan, 
              dan keputusasaan saling beradu. Saksikan kisah cinta yang tak kunjung usai, di mana harapan dan keputusasaan saling beradu.
              </p>
